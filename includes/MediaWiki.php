...
class MediaWiki {
	 ...
	 *
	 * @throws MalformedTitleException|BadURLError If a title has been provided by the user, but is invalid.
	...
	private function parseTitle() {
		...
		$badPath = $request->getBadPath();

		if ( $badPath !== null ) {
			throw new BadURLError( $badPath );
		}
		...
		// Use the main page as default title if empty/no title has been provided
		if ( $ret === null
			&& strval( $title ) === ''
	 ...
	 * @return Title
	 */
	public function getTitle( bool $rethrow = false ) {
		if ( !$this->context->hasTitle() ) {
			try {
				$this->context->setTitle( $this->parseTitle() );
			} catch ( BadURLError|MalformedTitleException $ex ) {
	...
	private function main() {
		...
		// Throw exception if title is invalid.
